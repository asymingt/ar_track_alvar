  ...
  namespace fisheye {
       ...
       OutputArray _rvec, OutputArray _tvec, bool useExtrinsicGuess, int flags)
    {
        ...
        if (flags == SOLVEPNP_EPNP || flags == SOLVEPNP_DLS || flags == SOLVEPNP_UPNP)
        {
            ...
            cv::fisheye::undistortPoints(ipoints, undistortedPoints, cameraMatrix, distCoeffs);
            ...
            CV_Error(CV_StsBadArg, "The flags argument must be one of SOLVEPNP_EPNP, SOLVEPNP_DLS, or SOLVEPNP_UPNP");
        return result;
    }
